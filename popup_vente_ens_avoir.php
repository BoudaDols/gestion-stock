<?php
	...
	WHERE r.reglement_codeFacture!='' AND r.statutReglement='A'	AND f.codeFacture = r.reglement_codeFacture	AND c.codeClient = f.facture_codeClient";
	$regl = SQLSelect($sql);
	$nl = 1;
?>
...
<html>
	<head>
		...
		<title>Etat des ventes à avoir</title>
	...
	<div class="col-lg-12">
		...
		<br><caption><b><u>ETAT DES VENTES A AVOIR</u></b></caption>
			<thead>
				<tr>
