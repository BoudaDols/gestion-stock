<?php
	...
	if(isset($_GET['action']))
	{
		...
		if($getaction=="cancel")//
		{
			...
			$action = "<br><br><br><a href='miserebut.php'><input type='button' 
	...
	if(isset($_POST['btnsubmit']))
	{
		...
		if($btnaction=="insert")
		{
			...
			if($qte > $qteStock)
			{
				$msg = "Quantités incorrectes!<br>La quantité à mettre au rebut est supérieure 
				à celle en stock.";
	...
	<div class="row col-lg-12">
		<div class="box box-primary">
			<div class="box-header">
				...
				<h3 class="box-title">Rebut Articles</h3>
			</div>
			<div class="box-body">
	...
	<div class="row col-lg-12">
		<div class="box box-primary">
			<div class="box-header">
				...
				<h3 class="box-title">Historique des rebuts</h3>
			</div>
			<div class="row">
				...
				<div class="box-body">
					<table class="table table-bordered" name="tabrebut" id="tabrebut">
						...
						<tbody>
							...
							?>
								<tr>
									<td colspan="6">Pas d'article mise au rebut.</td>
								</tr>
							<?php
							}
							else
							...
							?>
									<tr>
										<td><?= $numligne++;?></td>
										<td><?= $rebut->rebus_codeArticle; ?></td>
										<td><?= number_format($rebut->quantiteARebus, 0, ',', ' '); ?></td>
										<td><?= $rebut->motifRebus;?></td>
										<td><?= date_format(date_create($rebut->dateRebus),'d/m/Y');?></td>
										<td>
											<a href="miserebut.php?action=cancel&code=<?= $rebut->idRebus;?>&art=<?=$rebut->rebus_codeArticle;?>">
					...
					?>
						<ul class="pagination pagination-sm no-margin pull-right">
							<?php
								...
								{
							?>
									<li><a href="miserebut.php?page=<?= $i;?>"><?= $i;?></a></li>
					<?php
							}?>
						</ul>
					<?php	}
