<?php
	...
	statutReglement='C' AND codeFacture=reglement_codeFacture 
	...
	WHERE r.reglement_codeFacture!='' AND r.statutReglement='C'	AND f.codeFacture = r.reglement_codeFacture	AND c.codeClient = f.facture_codeClient";
	$regl = SQLSelect($sql);
	$nl = 1;
?>
...
<html>
	<head>
		...
		<title>Etat des ventes à crédit </title>
	...
	<div class="col-lg-12">
		...
		<br><caption><b><u>ETAT DES VENTES A CREDIT</u></b></caption>
			<thead>
				<tr>
