...
<?php
	...
	statutReglement='A' ORDER BY dateReglement DESC LIMIT $first, $parpage";
	$regl = SQLSelect($sqlr);
?>
	...
	<div class="row col-lg-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<h3 class="box-title">Etat des ventes à avoir</h3>
			</div>
			<div class="box-body">
...
?>
	...
	<script type="text/javascript">
		...
		function popup_vente()
		{
			...
			window.open('popup_vente_ens_avoir.php','GSF | Vente a avoir','menubar=no, scrollbars=no, top='+top+', left='+left+', width='+width+', height='+height+'');
		}
	</script>