...
<html>
	...
	<body class="skin-blue layout-boxed sidebar-min">
		...
		<div class="content">
			...
			<table  width="30px">
				<tr>
				<td><img src="<?=$logo;?>" alt=<?=$nom ?> height="20" width="20" /><?=$nom;?></td>
				<td><b><?=$nom;?></b></td>
				</tr>
				<tr><td><?=$adr;?><?=" --- ".$tel;?></td></tr>
			...
			<table  border="1" width="30">
				<thead>
					<tr>
						...
						<th style="text-align:left;">PVU</th>
						<th style="text-align:left;">PVT</th>
					</tr>
				</thead>
				<?php
					$nl = 1;
				...
				<tr>
					...
					<td style="width:55px;text-align:left;"><?=getLibArt($art->facture_codeArticle);?></td>
					<td style="width:25px;text-align:left;"><?=number_format($art->quantiteAFacture, 0, ',', ' ');?></td>
					<td style="width:25px;text-align:left;"><?=number_format($art->prixVenteFacture, 0, ',', ' ');?></td>
					<td style="width:15px;text-align:left;"><?=number_format($art->totalFacture, 0, ',', ' ');?></td>
				</tr>
				<?php
